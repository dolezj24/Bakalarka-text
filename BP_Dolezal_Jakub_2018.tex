...
\section{E-R model}
	E-R model\ref{er_model} popisuje relační databázový model navržený pro vyvýjený system. Model popisuje entity se všemi vlastnostmi a vazby mezi nimi. Je vytvořen v programu Skipper, který vygeneruje zdrojový kód zastřešujících PHP tříd včetně notací pro ORM knihovnu Doctrine 2. A pomocí schema-tool je zavedeno i databázové schéma. Vzhledem k jeho rozsáhlosti byl model rozdělen do několika sekcí.
