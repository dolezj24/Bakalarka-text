...
\subsection{Změna modelu v nástroji Skipper}
	Úprava modelu je jednoduchá, entity a jejich atributy se mění snadno pomocí formulářů. Pro nové entity je vhodné nastavit jméno vygenerovaného souboru s definicí. Tvar jména bude typicky \uv{<jméno entity>.php}. Do nové entity je také vhodné vložit atribut primárního klíče nazývaný \uv{id}, ačkoliv ve vygenerovaném souboru entity bude nahrazen použitím identifikačního traitu. Důležité je to především u entit, kde primární klíč bude sloužit jako cizí klíč v jiné tabulce. Díky tomu budou správně vygenerovány vazební vlasnostni tříd.
